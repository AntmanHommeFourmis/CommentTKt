<div class="container-fluid">
  <%= _.template($('#input_constructor').html())({
    id: "Data",
    description: tr("Target string"),
    default_selector: "string",
    disable_int: true,
    value_string: "",
    help: {
      description: tr("Target string to convert. If a value of the incorrect type is provided, it will be returned unchanged.")
    }
  }) %>
  <%= _.template($('#variable_constructor').html())({
    id: "Save",
    description: tr("Variable to save"),
    default_variable: "JSON_OBJECT",
    help: {
...
<div class="tooltipinternal">
  <div class="tr tooltip-paragraph-first-fold">Convert the selected string to a JSON object and return the result to a variable.</div>
  <div class="tr tooltip-paragraph-fold">Use the <a href="#!/JsonToString">JSON to string</a> action for reverse conversion (from object to string).</div>
  ...
  <div class="tr tooltip-paragraph-fold">With this action, you can convert a JSON string to a JavaScript object.</div>
