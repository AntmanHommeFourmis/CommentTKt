...
<div class="tooltipinternal">
  <div class="tr tooltip-paragraph-first-fold">Execute JSONPath query and get all matching keys.</div>
  ...
  <div class="tr tooltip-paragraph-fold">Consider an example. Suppose we got a line of the form <span style="color:black">{"Kate":{"rating":5,"count":6},"John":{"rating":1,"count":2}}</span> from a particular site. We want to get the names of people whose rating is greater than or equal to 1. This can easily be done using a query like <span style="color:black">$.[?(@.rating &gt;= 1)]</span>. Thus, as a result, we get a list of names satisfying our request.</div>
