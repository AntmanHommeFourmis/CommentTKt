...
Object.defineProperty(window, 'grecaptcha_$UNIQUE_PROCESS_NAME$', {set: function(value){
	if(typeof(value) == "undefined")
		return;

	Object.defineProperty(window, 'grecaptcha', {value: value, writable: true, enumerable: true, configurable: true});
	...
	try
	{
		...
		Object.defineProperty(window, 'grecaptcha', {value: _BAS_HIDE(BrowserAutomationStudio_GRecaptchaOriginal), writable: true, enumerable: true, configurable: true});
	}catch(e1)
	{
