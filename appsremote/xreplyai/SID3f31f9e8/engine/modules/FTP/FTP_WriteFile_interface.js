...
<%= _.template($('#checkbox').html())({id: "Check", title: tr("Add line ending symbol")}) %>
<%= _.template($('#checkbox').html())({id: "Check2", title: tr("Append file")}) %>
<%= _.template($('#checkbox').html())({id: "Check3", title: tr("Data is in base64 format")}) %>
