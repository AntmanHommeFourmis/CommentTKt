<div class="container-fluid">
  ...
  <%= _.template($('#block_start').html())({id: "Advanced", name: tr("Additional settings"), description: tr(""), smaller_fonts: true}) %>
    <%= _.template($('#checkbox').html())({id: "emulateMouse", title: tr("Emulate mouse movements"), checked: true}) %>
