...
<%= _.template($('#checkbox').html())({id: "Check", title: tr("Parameterize variables and resources in the query."), checked: true, help: {title:tr("Parameterize variables and resources"),description:tr("If enabled, data from variables and resources will be escaped.") + " " + tr("For different dialects, the result of parameterization may differ."),examples:[{code:tr("Activated"),description:tr("Value")+ " <code style=\"font-size:85%\">SELECT * FROM users WHERE name = [[NAME]]</code> " + tr("will be replaced by") + " <code style=\"font-size:85%\">SELECT * FROM users WHERE name = '" + tr("NAME variable content") + "'</code>"},{code:"<br/>" + tr("Deactivated"),description:tr("Value")+ " <code style=\"font-size:85%\">SELECT * FROM users WHERE name = [[NAME]]</code> " + tr("will be replaced by") + " <code style=\"font-size:85%\">SELECT * FROM users WHERE name = " + tr("NAME variable content") + "</code>"},{code:"<br/>" + tr("Activated"),description:tr("Value")+ " <code style=\"font-size:85%\">SELECT * FROM users WHERE country = {{country}}</code> " + tr("will be replaced by") + " <code style=\"font-size:85%\">SELECT * FROM users WHERE country = '" + tr("country resource content") + "'</code>"},{code:"<br/>" + tr("Deactivated"),description:tr("Value")+ " <code style=\"font-size:85%\">SELECT * FROM users WHERE country = {{country}}</code> " + tr("will be replaced by") + " <code style=\"font-size:85%\">SELECT * FROM users WHERE country = " + tr("country resource content") + "</code>"}]}}) %>
