(function () {
  Object.defineProperty(window, 'hcaptcha_$UNIQUE_PROCESS_NAME$', {
    set: function (value) {
      _BAS_HIDE(BrowserAutomationStudio_HCaptcha) = value;

      Object.defineProperty(window, 'hcaptcha', {value: _BAS_HIDE(BrowserAutomationStudio_HCaptcha), writable: true, enumerable: true, configurable: true});
