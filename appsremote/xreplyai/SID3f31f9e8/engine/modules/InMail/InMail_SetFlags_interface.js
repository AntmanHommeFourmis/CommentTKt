<div class="container-fluid">
	...
	<%= _.template($('#block_start').html())({id:"Additional", name: tr("Additional settings"), description: ""}) %>
		<%= _.template($('#checkbox').html())({id: "add", title: tr("Add flags to existing ones"), help: {title: tr("Add flags to existing ones"), description: tr("Optional parameter.") + " " + tr("If enabled, the specified flags will be added to the existing flags, rather than replacing them."), examples: [{code: tr("Activated"), description: tr("Add the specified flags to existing ones")}, {code: tr("Deactivated"), description: tr("Replace existing flags with the specified ones")}]}}) %>
