<div class="container-fluid">
	...
	<%= _.template($('#block_start').html())({id:"Additional", name: tr("Additional settings"), description: ""}) %>
		<%= _.template($('#checkbox').html())({id: "delAfter", title: tr("Delete message after receiving"), help: 
			{
				title: tr("Delete message after receiving"), 
				description: tr("Optional parameter.") + " " + tr("If activated, after successfully receiving the message will be deleted from the mailbox. When this parameter is enabled, the \"Set flags after receiving\" parameter is ignored."), 
				examples: 
				[
					{code: tr("Activated"), description: tr("Delete message after receiving")}, 
					{code: tr("Deactivated"), description: tr("Don't delete message after receiving")}
				]
			}
		}) %>
		
	
		<%= _.template($('#checkbox').html())({id: "setFlagsAfter", title: tr("Set flags after receiving"), help: 
			{
				title: tr("Set flags after receiving"), 
				description: tr("Optional parameter.") + " " + tr("If activated, after successfully receiving the message, one or more of the specified flags will be set for it. This parameter is ignored if the \"Delete message after receiving\" parameter is enabled."), 
				examples: 
				[
					{code: tr("Activated"), description: tr("Set message flags after receiving")},
					{code: tr("Deactivated"), description: tr("Don't set message flags after receiving")}
				]
			}
		}) %>
		<%= _.template($('#input_constructor').html())({
