...
<%= _.template($('#checkbox').html())({id: "Check", title: tr("Convert types")}) %>
...
<%= _.template($('#variable_constructor').html())({id:"ResultAsList", description:tr("Results as a list of items"), default_variable: "LIST_WITH_ITEMS", help: {description: tr("List of items. Results will be written into that list.")} }) %>
</div>
<div class="tooltipinternal">
	...
	<div class="tr tooltip-paragraph-fold">Additionally, this action will save the result as a list of items, it can be processed later with List module.</div>
