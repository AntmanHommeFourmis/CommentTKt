...
<%= _.template($('#checkbox').html())({id: "Check", title: tr("Replace multiple spaces with single ones"), checked: true}) %>
<%= _.template($('#checkbox').html())({id: "Check2", title: tr("Replace line breaks with space"), checked: true}) %>
<%= _.template($('#checkbox').html())({id: "Check3", title: tr("Remove tabs"), checked: true}) %>
