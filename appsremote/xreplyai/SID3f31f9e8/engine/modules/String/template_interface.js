<div class="container-fluid">
  ...
  <%= _.template($('#checkbox').html())({id: "Check2", title: tr("Expand spintax."), checked: true}) %>
  <%= _.template($('#checkbox').html())({id: "Check3", title: tr("Expand variables and resources."), checked: true}) %>
  <%= _.template($('#checkbox').html())({id: "Check", title: tr("Additional processing. Use this option if you want to load template from file or variable.")}) %>
