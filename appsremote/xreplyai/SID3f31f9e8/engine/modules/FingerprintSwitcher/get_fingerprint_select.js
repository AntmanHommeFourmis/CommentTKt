...
var SuppressWarnings = GetInputConstructorValue("SuppressWarnings", loader);
...
if(SuppressWarnings["original"].length == 0)
{
  Invalid("SuppressWarnings is empty");
  return;
}
  ...
  var code = loader.GetAdditionalData() + _.template($("#get_fingerprint_code").html())(
    {
      ...
      suppress_warnings: SuppressWarnings["updated"]
    })
