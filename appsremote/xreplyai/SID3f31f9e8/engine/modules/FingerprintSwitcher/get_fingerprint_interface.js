<div class="container-fluid">
  ...
  `}) %>
		...
		<%= _.template($('#info').html())({color: "gray", description: `
	...
	<%= _.template($('#block_start').html())({id: "Advanced", name: tr("Options"), description: tr("")}) %>
		...
		<%= _.template($('#input_constructor').html())({id:"SuppressWarnings", description:tr("Suppress configuration warnings"), default_selector: "string", value_string:"false", variants: ["true", "false"], help: 
		{
			description: tr("By default warnings will be displayed if this action is not configured properly and this configuration may lead to detection. You can suppress these warnings by setting this param. Warnings are displayed only in record mode."), examples:
			[
				{
					code:"true",description:tr("Don't display warnings")
				},
				{
					code:"false",description:tr("Display warnings about incorrect configuration")
				}
			]
		} }) %>
...
<div class="tooltipinternal">
      ...
      <div class="tooltip-paragraph-fold"><span class="tr">Fingerprints are fetched from</span> <a href="#"  onclick="BrowserAutomationStudio_OpenUrl('https://fp.bablosoft.com'); return false;">
	  ...
	  <div class="tr tooltip-paragraph-fold">Fingerprints are for personal usage only. Sending them to other users or sharing online is prohibited. This also includes embedding fingerprints inside compiled script. Violating this rule will lead to blocking your key without refund possibility.</div>
	  <div class="tooltip-paragraph-fold">
		<span class="tr">In order to embed fingerprints into your compiled script, you can ask each user to buy its own key. Alternative way is to use</span> 
		<span class="tr-en"><a href="#" onclick="BrowserAutomationStudio_OpenUrl('https://wiki.bablosoft.com/doku.php?id=fingerprintbusiness'); return false;">FingerprintBusiness</a>.</span>
		<span  class="tr-ru"><a href="#" onclick="BrowserAutomationStudio_OpenUrl('https://wiki.bablosoft.com/doku.php?id=ru:fingerprintbusiness'); return false;">FingerprintBusiness</a>.</span>
		<span class="tr">This service allows to assign fingerprint licenses to your users through web panel.</span>
	  </div>
