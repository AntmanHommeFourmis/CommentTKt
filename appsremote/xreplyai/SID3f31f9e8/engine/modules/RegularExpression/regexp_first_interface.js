    ...
    <%= _.template($('#variable_constructor').html())({id:"Result", description:tr("Captured groups"), default_variable: "GROUP1,GROUP2,GROUP3", append_mode:true, help: 
{
    ...
    <%= _.template($('#variable_constructor').html())({id:"GroupsAsList", description:tr("List of captured groups"), default_variable: "LIST_WITH_GROUPS", help: {description: tr("List of all captured groups. Results will be written into that list. The first element of the list will contain all the text extracted by the regular expression.")} }) %>
    ...
    <%= _.template($('#variable_constructor').html())({id:"ResultAll", description:tr("All string that matches regexp"), default_variable: "ALL_MATCH", help: 
{
    ...
    <div class="tooltipinternal">
          ...
          <div class="tr tooltip-paragraph-fold">Additionally, this action will save all captured groups into list, it can be processed later with List module.</div>
