...
var Groups = this.$el.find("#GroupsAsList").val().toUpperCase();
...
try{
  var code = loader.GetAdditionalData() + _.template($("#regexp_first_code").html())({variable:Result,resultall:"VAR_" + ResultAll,groups:"VAR_" + Groups,string:Value["updated"],regexp:Regexp["updated"]})
