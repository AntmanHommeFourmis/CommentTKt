    ...
    <%= _.template($('#input_constructor').html())({id:"Data", description:tr("Data"), default_selector: "string", disable_int:true, help: 
{
    ...
    <%= _.template($('#checkbox').html())({id: "Check", title: tr("Add to file/database instantly"), checked: true}) %>
    <%= _.template($('#checkbox').html())({id: "Check2", title: tr("Only write to file/database")}) %>
